        ...
        !function (e, n) {
            ...
            function k(t, e, n, i, o) {
                for (var r, s, a, l, u, c, p = e.createDocumentFragment(), f = [], d = 0, h = t.length; d < h; d++) if ((r = t[d]) || 0 === r) if ("object" === yt.type(r)) yt.merge(f, r.nodeType ? [r] : r); else if (Jt.test(r)) {
                    for (s = s || p.appendChild(e.createElement("div")), a = (Qt.exec(r) || [
                        "",
                        ""
                    ])[1].toLowerCase(), l = Kt[a] || Kt._default, s.innerHTML = l[1] + yt.htmlPrefilter(r) + l[2], c = l[0]; c--;) s = s.lastChild;
            ...
            function X(t, e, n) {
                ...
                if ((l = !yt.isEmptyObject(e)) || !yt.isEmptyObject(d)) {
                    p && 1 === t.nodeType && (n.overflow = [
                        h.overflow,
                        h.overflowX,
                        h.overflowY
                    ], u = m && m.display, null == u && (u = Ht.get(t, "display")), c = yt.css(t, "display"), "none" === c && (u ? c = u : (w([t], !0), u = t.style.display || u, c = yt.css(t, "display"), w([t]))), ("inline" === c || "inline-block" === c && null != u) && "none" === yt.css(t, "float") && (l || (f.done(function () {
                        h.display = u
                        ...
                        TAG: function (t) {
                            ...
                            return 1 === i && 0 === o ? function (t) {
                                ...
                                if (m) {
                                    ...
                                    } else if (y && (f = e, p = f[H] || (f[H] = {}), c = p[f.uniqueID] || (p[f.uniqueID] = {}), u = c[t] || [], d = u[0] === M && u[1], b = d), !1 === b) for (; (f = ++d && f && f[g] || (b = d = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++b || (y && (p = f[H] || (f[H] = {}), c = p[f.uniqueID] || (p[f.uniqueID] = {}), c[t] = [
                                        M,
                                        b
                                    ]), f !== e));) ;
            ...
            (yt.fn.init = function (t, e, n) {
                ...
                if (n = n || Nt, "string" == typeof t) {
                    if (!(i = "<" === t[0] && ">" === t[t.length - 1] && t.length >= 3 ? [
                        ...
                        t,
                        null
                    ] : At.exec(t)) || !i[1] && e) return !e || e.jquery ? (e || n).find(t) : this.constructor(e).find(t);
                    if (i[1]) {
            ...
            yt.extend({
                ...
                detach: function (t) {
                    ...
                    return qt(this, function (t) {
                        ...
                        if ("string" == typeof t && !oe.test(t) && !Kt[(Qt.exec(t) || [
                            "",
                            ""
                        ])[1].toLowerCase()]) {
            ...
            var pe = /^(none|table(?!-c[ea]).+)/, fe = /^--/,
                ...
                he = { letterSpacing: "0", fontWeight: "400" }, ge = [
                    "Webkit",
                    "Moz",
                    "ms"
            ...
            Ue.href = $e.href, yt.extend({
                ...
                ajax: function (t, e) {
                    function i(t, e, i, a) {
                        var u, f, d, x, w, T = e;
                        c || (c = !0, l && n.clearTimeout(l), o = void 0, s = a || "", C.readyState = t > 0 ? 4 : 0, u = t >= 200 && t < 300 || 304 === t, i && (x = it(h, C, i)), x = ot(h, x, C, u), u ? (h.ifModified && (w = C.getResponseHeader("Last-Modified"), w && (yt.lastModified[r] = w), (w = C.getResponseHeader("etag")) && (yt.etag[r] = w)), 204 === t || "HEAD" === h.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = x.state, f = x.data, d = x.error, u = !d)) : (d = T, !t && T || (T = "error", t < 0 && (t = 0))), C.status = t, C.statusText = (e || T) + "", u ? v.resolveWith(g, [
                            f,
                            T,
                            C
                        ]) : v.rejectWith(g, [
                            ...
                            T,
                            d
                        ]), C.statusCode(b), b = void 0, p && m.trigger(u ? "ajaxSuccess" : "ajaxError", [
                            C,
                            h,
                            u ? f : d
                        ]), y.fireWith(g, [
                    ...
                    var o, r, s, a, l, u, c, p, f, d, h = yt.ajaxSetup({}, e), g = h.context || h,
                        ...
                        y = yt.Callbacks("once memory"), b = h.statusCode || {}, x = {}, w = {}, T = "canceled", C = {
                            readyState: 0, getResponseHeader: function (t) {
                                ...
                                var e;
                                if (t) if (c) C.always(t[C.status]); else for (e in t) b[e] = [
                                    b[e],
                                    t[e]
                                ];
                                return this
                    ...
                    if (T = "abort", y.add(h.complete), C.done(h.success), C.fail(h.error), o = et(We, h, e, C)) {
                        if (C.readyState = 1, p && m.trigger("ajaxSend", [
                            C,
                            h
                        ]), c) return C;
                    ...
                    if (this.$element.trigger(c), !c.isDefaultPrevented()) {
                        ...
                        return t.support.transition && this.$element.hasClass("slide") ? (r.addClass(e), r[0].offsetWidth, o.addClass(a), r.addClass(a), o.one("bsTransitionEnd", function () {
                            r.removeClass([
                                e,
                                a
                            ].join(" ")).addClass("active"), o.removeClass([
                                "active",
                                a
                            ].join(" ")), l.sliding = !1, setTimeout(function () {
                                l.$element.trigger(f)
                            }, 0)
