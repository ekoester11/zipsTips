function formatList() {
    ...
    {
        "dt": "11/06/2002",
        "tiptxt": "Start doing 50/50 (pushups/crunches) every night before you go to sleep. In two weeks you will see a difference in your throwing and cutting power.",
...
"important": true
    ...
    {
        "dt": "04/21/2003",
        "tiptxt": "When you are going to make a catch on a low disc, there are two acceptable ways to catch: 1) go into a slide 2) run to the spot where you want to catch and then get low for the disc. First of all, in both cases you want to get your body in front of where you want to catch, aka 'the break basket'. Secondly, you certainly do not want to run for any number of steps with your hands down around your knees. This is as silly as running with your hands over your head to catch a high disc. The former is much more common but just as ineffective - it is extremely hard to maintain speed and balance running in this way.",
        "title": "Getting Low"
    },
    {
        "dt": "04/22/2003",
    ...
    let list = document.getElementById('zipsTips')

    data.forEach(tip => {
        let li = document.createElement("li");
        li.innerText = tip.tiptxt;
